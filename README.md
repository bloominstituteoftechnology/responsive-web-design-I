...
* [X] Review each [design file](design-files).  Notice the subtle differences between th Insert a `viewport` meta tag into the head of the project with these html attributes: `content="width=device-width, initial-scale=1"`
